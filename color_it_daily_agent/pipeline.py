...
from color_it_daily_agent.context import AgentContext, set_agent_context
...
def prepare_agent_execution(input_payload: Dict[str, Any]) -> Tuple[AgentContext, Dict[str, Any]]:
    ...
    3. Pre-creates a Firestore (or local if no_persist) document with status='running'.
    4. Sets up and returns the AgentContext.
    """
